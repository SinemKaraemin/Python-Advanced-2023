...
while products:
    ...
    robots = {r[0]: [r[1][0], r[1][1] - 1] if r[1][1] != 0 else r[1] for r in robots.items()}  # definitely not worth the comprehension
    ...
    robots[free_robots[0][0]][1] = free_robots[0][1][0]  # robots[free_robots[0][0]][1] = time_set, free_robots[0][1][0] = time_needed
